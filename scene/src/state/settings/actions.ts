...
export type SettingsActions =
  | LoadSettingsFromExplorerAction
  | SaveSettingsToExplorerAction
  | DiscardNewValuesAction
  | SetSettingValueAction

export const loadSettingsFromExplorer = (
  settings: Record<string, ExplorerSetting>
): LoadSettingsFromExplorerAction => ({
  __reducer: 'settings',
  type: 'LOAD_SETTINGS_FROM_EXPLORER',
  payload: settings
})
export const saveSettingsToExplorer = (): SaveSettingsToExplorerAction => ({
  __reducer: 'settings',
  type: 'SAVE_SETTINGS_TO_EXPLORER'
})
export const discardNewValues = (): DiscardNewValuesAction => ({
  __reducer: 'settings',
  type: 'DISCARD_NEW_VALUES'
})
export const setSettingValue = (payload: {
  name: string
  value: number
}): SetSettingValueAction => ({
  __reducer: 'settings',
