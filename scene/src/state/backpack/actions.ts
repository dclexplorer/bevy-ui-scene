...
import {type CatalogWearableElement, type WearableEntityMetadata} from "../../utils/wearables-definitions";
...
export const updateSelectedWearableURN = (payload: URNWithoutTokenId | null): BackpackSelectWearableURNAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.SELECT_WEARABLE_URN,
    payload
})

export const updateCurrentPage = (payload: number): BackpackUpdateCurrentPageAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_CURRENT_PAGE,
    payload
})

export const updateActiveWearableCategory = (payload: WearableCategory | null): BackpackUpdateActiveWearableCategoryAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_ACTIVE_WEARABLE_CATEGORY,
    payload
})

export const updateLoadingPage = (payload:boolean):BackpackUpdateLoadingPageAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_LOADING_PAGE,
    payload
})

export const updateLoadedPage = (payload:BackpackUpdateLoadedPagePayload):BackpackUpdateLoadedPageAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_LOADED_PAGE,
    payload
})

export const updateEquippedWearables = (payload:BackpackUpdateEquippedWearablesPayload):BackpackUpdateEquippedWearablesAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_EQUIPPED_WEARABLES,
    payload
})

export const updateAvatarBase = (payload:BackpackUpdateAvatarBasePayload):BackpackUpdateAvatarBaseAction => ({
    __reducer: BACKPACK_STORE_ID,
    type: BACKPACK_ACTION.UPDATE_AVATAR_BASE,
    payload
})